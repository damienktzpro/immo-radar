...
UA="Mozilla/5.0 (compatible; RadarImmobilier/3.0; +https://github.com/damienktzpro/immo-radar)"
TIMEOUT=22
MAX_PER_SOURCE=16
MAX_TOTAL=240
...
def main():
    ...
    data={"generated_at":now(),"version":"3.0","items":final,"source_stats":counts,"health":health,"errors":errors}
